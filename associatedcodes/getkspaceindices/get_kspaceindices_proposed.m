function [ind_full,ind_filter] = get_kspaceindices_proposed(overres,res,filter_siz)
%%% This functions returns the indices corresponding to the filter
%%% coefficients and the kspace data.The indices returned are consistent
%%% with matlab convention.
