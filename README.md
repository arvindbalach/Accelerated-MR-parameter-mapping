...
**To replicate the results corresponding to the proposed fast method in the paper, run the codes main_coilcombined.m and main_multichannel.m present inside the proposed_fast folder. To see the results corresponding to the direct implementation run the main_coilcombined.m present inside the direct_implementation folder.**
